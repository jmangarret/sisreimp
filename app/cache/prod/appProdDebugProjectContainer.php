...
class appProdDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => '5432', 'dbname' => 'bd_sisreimp', 'user' => 'postgres', 'password' => 'postgres', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_9c9a57ae8e0044048f70884c136aa9ad');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_9c9a57ae8e0044048f70884c136aa9ad');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_9c9a57ae8e0044048f70884c136aa9ad');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => __DIR__.'/../../../src/Sistema/SisreimpBundle/Entity')), 'Sistema\\SisreimpBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('SistemaSisreimpBundle' => 'Sistema\\SisreimpBundle\\Entity'));
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '9bf6a98ae78f8b213411dedd1d460d24c5f4a16b');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(__DIR__.'/../../../src/Sistema/SisreimpBundle/Resources/views', 'SistemaSisreimp');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('9bf6a98ae78f8b213411dedd1d460d24c5f4a16b');
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), __DIR__.'/../../../web', true);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SistemaSisreimpBundle' => 'Sistema\\SisreimpBundle\\SistemaSisreimpBundle',
            ),
            ...
            'locale' => 'en',
            'secret' => '9bf6a98ae78f8b213411dedd1d460d24c5f4a16b',
            'database_path' => NULL,
            ...
            'kernel.secret' => '9bf6a98ae78f8b213411dedd1d460d24c5f4a16b',
