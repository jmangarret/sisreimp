...
class ActividadesEmpresaControllerTest extends WebTestCase
{
    /*
    public function testCompleteScenario()
    {
        ...
        $crawler = $client->request('GET', '/actividadesempresa/');
        $this->assertEquals(200, $client->getResponse()->getStatusCode(), "Unexpected HTTP status code for GET /actividadesempresa/");
